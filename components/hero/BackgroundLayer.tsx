  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          height: '100vh',
          background: 'linear-gradient(to bottom, #0974FD 0%, #E4F8F5 100%)',
        }}
      >
        ...
        {/* ── BOTTOM-LEFT Cloud (User Asset - Inverted as requested) ───── */}
        <div className="cloud-4 absolute top-[45%] left-0 w-[38%] max-w-[460px]">
          <img
            src="/clouds/cloud-bottom-left-user.png"
            alt=""
            className="w-full h-auto block object-contain object-left scale-x-[-1]"
          />
        </div>

        {/* ── BOTTOM-RIGHT Cloud (User Asset - Inverted as requested) ──── */}
        <div className="cloud-5 absolute top-[45%] right-0 w-[38%] max-w-[460px]">
          <img
            src="/clouds/cloud-bottom-left-user.png"
            alt=""
